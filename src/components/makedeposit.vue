<template>
    <div id="makedeposit">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                    <v-alert border="left" colored-border class="shadow alert pl-4  mt-5 text-dark" color="#9C27B0"
                        elevation="2">
                        <p class="mb-0 font-weight-bold ml-5">Account Balance: <br> <span
                                class="font-weight-bold amount">{{ "₦" + getBal + ":00" }}</span></p>
                    </v-alert>
                </div>


                <div class="col-lg-8 shadow form-section mx-auto py-4 mt-4">
                    ...
                    <form class="form-class mx-auto shadow p-5" @submit.prevent="makeDeposit">
                        ...
                        <input type="number" name="ban" v-model="input.acctBan" placeholder="Your BAN"
                            class="form-control mb-3" required />
                        <input type="number" name="amount" v-model="input.amount"
                            placeholder="Enter  Amount e.g 1000, 5000, 10000..." class="form-control mb-3" required />
